...
class Client {
    ...
    private static void receiveFile(String rawInput,
        ...
        // REQUEST LOGIC
        //      Send initial request for a file and get response
        ...
        // Create new file object for the downloaded file in the program's directory
        File newFile = new File(System.getProperty("user.dir"), fileName);
        byte[] buffer = new byte[1000000]; // File transfer buffer is 1mb
        boolean readyToReceive = false;    // True if client is ready to download
        ...
        // DOWNLOAD LOGIC
        //      Both server and client are ready, proceed with file transfer
        if (readyToReceive) {
